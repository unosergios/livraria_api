...
import br.alura.com.livraria.service.UsuarioService;
...
@Api(tags = "usuarios do sistemas livraria")
public class UsuarioController {
 ...
 public ResponseEntity<UsuarioDto> cadastrar(@RequestBody @Valid UsuarioFormDto dto,
	...
	@DeleteMapping("/{id}")
	@ApiOperation("Excluir usuarios")
	public ResponseEntity<UsuarioDto> excluir(@PathVariable @NotNull Long id) {
		service.excluir(id);
	...
	@GetMapping("/{id}")
	@ApiOperation("Detalhar usuarios")
